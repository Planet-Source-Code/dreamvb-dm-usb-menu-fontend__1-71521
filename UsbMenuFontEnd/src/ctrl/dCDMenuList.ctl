...
Event Selected(ByVal Index As Long)
Event Change()
...
Public Property Get Caption(Index As Long) As String
On Error Resume Next
    Caption = m_ItemData(Index).iCaption
End Property

Public Property Let Caption(Index As Long, NewCaption As String)
    m_ItemData(Index).iCaption = NewCaption
End Property
...
Dim ItemY As Long
    ...
    ItemY = (Item - vBar.Value - 1) * (m_ItemSize - 2.5) '1
